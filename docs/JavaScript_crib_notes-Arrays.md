...
* [Arrays](#arrayshttpsdevelopermozillaorgen-usdocswebjavascriptreferenceglobal_objectsarray)
	* [Notes](#notes)
	...
	* [Common properties and methods with code](#common-properties-and-methodshttpsdevelopermozillaorgen-usdocswebjavascriptreferenceglobal_objectsarray-with-code)
		* [`.length -> int` - returns number of elements](#length-inthttpsdevelopermozillaorgen-usdocswebjavascriptreferenceglobal_objectsarraylength-returns-number-of-elements)
		* [`.push(arg1, arg2, ...)` - append element(s)](#pusharg1-arg2-httpsdevelopermozillaorgen-usdocswebjavascriptreferenceglobal_objectsarraypush-append-elements)
		* [`.pop() -> element`  - remove and return last element](#pop-elementhttpsdevelopermozillaorgen-usdocswebjavascriptreferenceglobal_objectsarraypop-remove-and-return-last-element)
		* [`.join(optional_delimiter) -> String` - concatenate elements into string](#joinoptional_delimiter-stringhttpsdevelopermozillaorgen-usdocswebjavascriptreferenceglobal_objectsarrayjoin-concatenate-elements-into-string)
		* [`.slice(optinal_begin, optional_end) -> new Array` - return portion of array](#sliceoptinal_begin-optional_end-new-arrayhttpsdevelopermozillaorgen-usdocswebjavascriptreferenceglobal_objectsarrayslice-return-portion-of-array)
		* [`.splice(args)` - remove existing elements and/or add new elements](#spliceargshttpsdevelopermozillaorgen-usdocswebjavascriptreferenceglobal_objectsarraysplice-remove-existing-elements-andor-add-new-elements)
		* [`.shift()` - remove first element](#shifthttpsdevelopermozillaorgen-usdocswebjavascriptreferenceglobal_objectsarrayshift-remove-first-element)
		* [`.unshift(element1, element2, ....) -> new_length` - prepend elements](#unshiftelement1-element2-new_lengthhttpsdevelopermozillaorgen-usdocswebjavascriptreferenceglobal_objectsarrayunshift-prepend-elements)
		* [`.concat(args) -> new Array` - merge two or more arrays](#concatargs-new-arrayhttpsdevelopermozillaorgen-usdocswebjavascriptreferenceglobal_objectsarrayconcat-merge-two-or-more-arrays)
	* [Iterators](#iteratorshttpsdevelopermozillaorgen-usdocswebjavascriptguideiterators_and_generatorsiterators)
	...
	* [Common iterators with example code](#common-iteratorshttpsdevelopermozillaorgen-usdocswebjavascriptreferenceglobal_objectsarrayiteration_methods-with-example-code)
		* [`.forEach(function)` - iterate over each element](#foreachfunctionhttpsdevelopermozillaorgen-usdocswebjavascriptreferenceglobal_objectsarrayforeachsyntax-iterate-over-each-element)
		* [`.map(function) -> new Array` - return mapped elements](#mapfunction-new-arrayhttpsdevelopermozillaorgen-usdocswebjavascriptreferenceglobal_objectsarraymap-return-mapped-elements)
		* [`.filter(function) -> new Array` - return matching elements](#filterfunction-new-arrayhttpsdevelopermozillaorgen-usdocswebjavascriptreferenceglobal_objectsarrayfilter-return-matching-elements)
		* [`.findIndex(function) -> int` - return index of 1st matching element](#findindexfunction-inthttpsdevelopermozillaorgen-usdocswebjavascriptreferenceglobal_objectsarrayfindindex-return-index-of-1st-matching-element)
		* [`.reduce(function, optional_start_value) -> value` - return single accumulated value](#reducefunction-optional_start_value-valuehttpsdevelopermozillaorgen-usdocswebjavascriptreferenceglobal_objectsarrayreduce-return-single-accumulated-value)
		* [`.every(function)` -> boolean - returns true if all elements pass the provided test](#everyfunction-booleanhttpsdevelopermozillaorgen-usdocswebjavascriptreferenceglobal_objectsarrayevery-returns-true-if-all-elements-pass-the-provided-test)
		* [`.some(function)` -> boolean - returns true if any elements passes the provided test](#somefunction-booleanhttpsdevelopermozillaorgen-usdocswebjavascriptreferenceglobal_objectsarraysome-returns-true-if-any-elements-passes-the-provided-test)
